...
public class CCValue implements org.apache.thrift.TBase<CCValue, CCValue._Fields>, java.io.Serializable, Cloneable, Comparable<CCValue> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CCValue");
  ...
  static {
    schemes.put(StandardScheme.class, new CCValueStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CCValueTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CCValue.class, metaDataMap);
  }
  ...
  public CCValue deepCopy() {
    return new CCValue(this);
  }
  ...
  public CCValue setIsnull(boolean isnull) {
    this.isnull = isnull;
    setIsnullIsSet(true);
    return this;
  }
  ...
  public CCValue setVal(RawVal val) {
    this.val = val;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CCValue)
      return this.equals((CCValue)that);
    return false;
  }

  public boolean equals(CCValue that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CCValue other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CCValue(");
    boolean first = true;
  ...
  private static class CCValueStandardSchemeFactory implements SchemeFactory {
    public CCValueStandardScheme getScheme() {
      return new CCValueStandardScheme();
    }
  }

  private static class CCValueStandardScheme extends StandardScheme<CCValue> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CCValue struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CCValue struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CCValueTupleSchemeFactory implements SchemeFactory {
    public CCValueTupleScheme getScheme() {
      return new CCValueTupleScheme();
    }
  }

  private static class CCValueTupleScheme extends TupleScheme<CCValue> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CCValue struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CCValue struct) throws org.apache.thrift.TException {
