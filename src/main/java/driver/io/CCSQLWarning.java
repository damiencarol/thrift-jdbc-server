...
public class CCSQLWarning implements org.apache.thrift.TBase<CCSQLWarning, CCSQLWarning._Fields>, java.io.Serializable, Cloneable, Comparable<CCSQLWarning> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CCSQLWarning");
  ...
  static {
    schemes.put(StandardScheme.class, new CCSQLWarningStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CCSQLWarningTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CCSQLWarning.class, metaDataMap);
  }
   ...
   */
  public CCSQLWarning(CCSQLWarning other) {
  ...
  public CCSQLWarning deepCopy() {
    return new CCSQLWarning(this);
  }
  ...
  public CCSQLWarning setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public CCSQLWarning setState(String state) {
    this.state = state;
    return this;
  }
  ...
  public CCSQLWarning setVendorCode(int vendorCode) {
    this.vendorCode = vendorCode;
    setVendorCodeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CCSQLWarning)
      return this.equals((CCSQLWarning)that);
    return false;
  }

  public boolean equals(CCSQLWarning that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CCSQLWarning other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CCSQLWarning(");
    boolean first = true;
  ...
  private static class CCSQLWarningStandardSchemeFactory implements SchemeFactory {
    public CCSQLWarningStandardScheme getScheme() {
      return new CCSQLWarningStandardScheme();
    }
  }

  private static class CCSQLWarningStandardScheme extends StandardScheme<CCSQLWarning> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CCSQLWarning struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CCSQLWarning struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CCSQLWarningTupleSchemeFactory implements SchemeFactory {
    public CCSQLWarningTupleScheme getScheme() {
      return new CCSQLWarningTupleScheme();
    }
  }

  private static class CCSQLWarningTupleScheme extends TupleScheme<CCSQLWarning> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CCSQLWarning struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CCSQLWarning struct) throws org.apache.thrift.TException {
